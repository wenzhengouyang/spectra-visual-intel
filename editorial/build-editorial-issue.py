...
EXPANDED_STORY_COPY = {
    ...
    "evt_204f914826bac164": {
        "headline": "快手中期收入微增，可灵AI资产重组进入期后事项",
        "dek": "快手2026年中期收入同比增长1.4%，三项利润指标同比下降；财报同时披露了北京可灵的增资、员工持股与资产重组安排。",
        "one_line_takeaway": "集团财务表现与可灵AI重组应分开判断：前者反映整体经营，后者才是视觉生成业务后续需要持续跟踪的结构性信号。",
        "what": (
            "快手科技披露，2026年中期收入为355.35亿元，同比增长1.4%；净利润为31.52亿元，同比下降36.0%。"
            "同期非国际财务报告准则经调整净利润为39.13亿元，同比下降30.3%；经调整EBITDA为71.22亿元，同比下降7.7%。"
        ),
        "fact_points": [
            "财报将北京可灵的增资、员工持股计划与资产重组列为期后事项。",
        ...
        "summary_paragraphs": [
            "快手科技2026年中期收入为355.35亿元，同比增长1.4%；净利润为31.52亿元，同比下降36.0%。同期非国际财务报告准则经调整净利润为39.13亿元，同比下降30.3%；经调整EBITDA为71.22亿元，同比下降7.7%。",
            "财报在期后事项中披露，北京可灵与集团部分子公司签订了增资协议，并采用三项员工持股计划；相关重组框架安排由北京可灵承接集团的可灵AI相关资产与业务。",
        ],
        "why": (
            "收入小幅增长与三项利润指标下降同时出现，但这些是集团整体口径，不能据此推断可灵AI自身的收入、成本或盈利表现。"
            "对视觉智能行业更有价值的信号，是快手正在把可灵AI相关资产与业务归集到北京可灵；现有披露仍不足以判断重组后的独立经营规模。"
        ),
        "how": (
            "财报在期后事项中披露，北京可灵与集团部分子公司签订了增资协议，并采用三项员工持股计划。"
            "相关重组框架安排由北京可灵承接集团的可灵AI相关资产与业务。该事项披露了组织和资产边界的变化，但没有提供可灵AI独立收入或利润数据。"
        ),
        "watch": ["重组完成后是否单独披露可灵AI收入、付费客户或调用规模？", "相关资产归集与增资安排何时完成？", "集团利润指标的同比变化是否在后续季度收窄？"],
        "claim_ids": [
            "clm_204f914826bac164_03",
